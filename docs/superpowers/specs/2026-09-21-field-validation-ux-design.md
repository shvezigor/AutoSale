...
Для профілю відправника Nova Poshta також перевіряються відправник, контакт, телефон, точка відправлення, вага/габарити та шаблон повідомлення до API-запиту; відповідне поле отримує пояснення й фокус, а редагування очищає саме його помилку. Такий самий submit-first підхід застосовано до профілю Meest (ім'я, телефон, відділення, габарити, шаблон). Профіль Укрпошти і чернетка ТТН ще очікують аналогічної міграції.
5. Public demo form.
