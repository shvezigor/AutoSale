...
Репозиторний контракт інвентаризує всі production-форми та допускає лише два задокументовані non-field винятки для Google Picker. Повний набір автоматизованих тестів і браузерний тест демоформи на чотирьох ширинах пройшли. Вхід у реальний обліковий запис для browser smoke та перевірка вже розгорнутого сайту записуються окремо в [приймальному чеклисті](../../acceptance/field-validation-checklist.md).
