...
- [ ] Для старих замовлень з уже наявною Telegram-подією виконання (приклад `MN-000013`) UI повинен показувати причину блокування до натискання кнопки, а не загальну помилку після серверної відмови.
