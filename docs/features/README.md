...
| AI order recognition from conversations | Available | [`Instagram order capture design`](../superpowers/specs/2026-08-26-instagram-order-capture-design.md) | `apps/worker/src/orders`, `packages/contracts/src/orders.ts`, `apps/api/src/orders` |
...
| Google Sheets connection and exactly-once order export | Available | [`Google OAuth design`](../superpowers/specs/2026-09-02-google-sheets-oauth-connection-design.md), [`setup`](../integrations/google-oauth-setup.md), [`access model`](../integrations/google-sheets-access.md) | `apps/api/src/integrations/google-*`, `apps/api/src/settings/google-sheets-*`, `packages/integrations/src/google-*`, `tests/e2e/google-oauth-sheets.spec.ts` |
| Order review, approval and audit | Available | [`order capture design`](../superpowers/specs/2026-08-26-instagram-order-capture-design.md) | `apps/api/src/orders`, `apps/web/app/(workspace)/orders`, `apps/web/src/components/order-review-panel.tsx` |
