...
| Order commercial terms, legal entities and bank accounts | Planned | [`commercial terms and bank accounts design`](../superpowers/specs/2026-09-19-order-commercial-terms-and-bank-accounts-design.md) | No production implementation yet. First stage snapshots expected order totals and filters active accounts by tenant legal entity and currency; actual payment ledger follows separately. |
