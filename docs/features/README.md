...
| Consistent field validation UX across forms | In progress | [`field validation UX`](../superpowers/specs/2026-09-21-field-validation-ux-design.md) | Shared field controls and safe API issues cover auth, profile, team, catalogue, order, payment, delivery, supplier chat, Instagram reply and public demo. Google picker forms retain integration-level failures because tabs are provider-selected. Repository audit, full suite and browser acceptance remain. |
