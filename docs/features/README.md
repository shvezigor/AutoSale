...
| Meta Instagram OAuth, webhook ingestion and inbox | Validation pending | [`Instagram system design`](../superpowers/specs/2026-08-26-instagram-order-capture-design.md), [`Meta access`](../integrations/meta-access.md), [`OAuth runbook`](../integrations/meta-instagram-oauth.md), [`MVP acceptance`](../acceptance/mvp-checklist.md) | `apps/api/src/meta`, `apps/api/src/integrations/instagram-*`, `apps/worker/src/instagram`, `apps/api/src/conversations`, `apps/web/src/components/message-thread.tsx`; shared posts, reels, stories and unknown attachments retain a visible safe representation, including idempotent recovery of legacy empty messages. |
