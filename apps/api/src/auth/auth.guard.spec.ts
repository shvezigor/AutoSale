...
const owner: AuthPrincipal = { userId: 'u', email: 'o@example.com', name: 'Owner', platformRole: 'USER', tenantId: 't', membershipRole: 'OWNER', locale: 'uk', avatarUrl: null, sessionId: 's' };
