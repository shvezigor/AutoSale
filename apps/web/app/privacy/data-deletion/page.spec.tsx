...
describe('DataDeletionPage', () => {
  it('shows a safe receipt without claiming that the whole Sales AITO account was deleted', async () => {
    ...
    expect(screen.queryByText(/обліковий запис Sales AITO видалено/)).not.toBeInTheDocument();
  });
});
