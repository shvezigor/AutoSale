...
describe('DashboardPage', () => {
  ...
  it('loads a real 30-day snapshot by default and exposes shareable period links', async () => {
    ...
    const newOrders = screen.getByRole('heading', { name: 'Нові замовлення' }).closest('article');
    expect(newOrders).not.toBeNull();
    expect(within(newOrders!).getByText('18')).toBeInTheDocument();
  });
